...
@section('content')	
		...
		<div class="category-bar navbar">
			<a href="#" class="hvr-underline-from-center">女装</a>
			<a href="#" class="hvr-underline-from-center">男装</a>
			<a href="#" class="hvr-underline-from-center">鞋帽</a>
			<a href="#" class="hvr-underline-from-center">食饮</a>
			<a href="#" class="hvr-underline-from-center">包表</a>
			<a href="#" class="hvr-underline-from-center">美护</a>
			<a href="#" class="hvr-underline-from-center">家居</a>
			<a href="#" class="hvr-underline-from-center">其他</a>
		</div>
		</div>
		...
		<div class="wrapper full-height">
			...
			<div class="listing">
				...
				<div class="row">
					<div class="col-xs-4">
						<img src="/client/images/product.jpg" alt="product" class="product" />
					</div>
					<div class="col-xs-8">
						<div class="description">双人被夏凉被空调被双人被夏凉被空调被101女团新色系</div>
				...
				<div class="row">
					<div class="col-xs-4">
						<img src="/client/images/product_01.jpg" alt="product" class="product" />
					</div>
					<div class="col-xs-8">
						<div class="description">双人被夏凉被空调被双人被夏凉被空调被101女团新色系</div>
						<div class="price">¥ 338.00</div>
